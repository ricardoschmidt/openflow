#
# OpenFlow controller built on top of Ryu.
#
# Uses flow_removed and flow_stats messages to retrieve flow-level measurements from OpenFlow switch.
#
# This code is at experimental level.
#
# Oct 29, 2014
#
...
class L3Switch13(app_manager.RyuApp):
    ...
    HARD_TIMEOUT = 15 
    OUTPUT_DIR = "/tmp/"
    INITIAL_RUNS = 20 # should be 10 or something?

    def __init__(self, *args, **kwargs):
        super(L3Switch13, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        if 'BASH_PID' in os.environ:
            print "L3Switch running in OF Measurement Framework Mode"
            self.BASH_PID = int(os.environ['BASH_PID'])
    ...
    def SIGUSR1Handler(self, signum, frame):
        print "RYU: got SIGUSR1, assuming tcpreplay is done"
